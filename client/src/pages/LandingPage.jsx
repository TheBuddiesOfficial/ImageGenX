...
import OG from '/assets/img/ImageGenX_OG.png';
  ...
  return (
    <div>
      <Helmet>
        ...
        <meta name="description" content="Generate AI Image using ImageGenX" />
        <title>Home - ImageGenX</title>
        <meta name="theme-color" content="#0a192f" />
        <link rel="shortcut icon" href='/favicon.ico' sizes="any" />
        <link rel="manifest" href="/manifest.json" />
        <meta httpEquiv="Content-Type" content="text/html; charset=UTF-8" />
        <meta name="author" content="TheBuddyzTeam"></meta>
        <meta name="robots" content="index,follow" />
        <meta
          name="keywords"
          content="AI Artificial Intelligence TheBuddyzTeam Developer OpenAi DALL-E image generator Aniyikaye coding web-development server MERN mongodb expressjs reactjs"
        />

        {/* Og */}
        <meta property="og:title" content="Home - ImageGenX" />
        <meta
          property="og:description"
          content="Generate AI Image using ImageGenX"
        />
        <meta property="og:site_name" content="Home - ImageGenX" />
        <meta property="og:url" content="https://imagegenx.vercel.app" key="ogurl" />
                <meta property="og:image" content={`https://imagegenx.vercel.app/assets/img/ImageGenX_OG.png`} />

        {/* Twitter */}
        <meta name="twitter:card" content="summary_large_image" />
        <meta name="twitter:creator" content="@Emmanuel_Omoiya" />
        <meta name="twitter:title" content="Home - ImageGenX" />
        <meta
          name="twitter:description"
          content="Generate AI Image using ImageGenX"
        />
        <meta name="twitter:image" content={OG} />
        <meta name="twitter:image:alt" content={`https://imagegenx.vercel.app/assets/img/ImageGenX_OG.png`}></meta>
        <meta name="twitter:domain" content="https://imagegenx.vercel.app" />
      </Helmet>
      <section className="w-full flex flex-col md:flex-row py-6 md:py-12 min-h-[70vh] items-center relative sm:px-20 px-6 font-poppins ">
        <div className="flex flex-col w-full md:w-6/12 relative">
          ...
          <p className="font-poppins text-slate text-[1.05rem] font-medium mt-7 ">
            ...
            <span className="font-poppins font-bold">ImageGenX</span> we'll help you
        ...
        <div className="max-w-7xl mx-auto font-poppins lg:px-8 sm:px-20 px-6">
          <div className="lg:text-center">
            ...
            <p className="mt-4 max-w-2xl text-xl text-gray-500 lg:mx-auto font-poppins">
              Create imaginative and visually stunning images through ImageGenX
        ...
        <div className="flex flex-col md:flex-row my-8 text-green_opaque mt-[4rem]">
          ...
          <div className="w-full md:w-6/12 flex flex-col justify-center my-6 md:my-0">
            ...
            <p className="text-slate md:pr-10 my-6 md:text-lg 2xl:text-xl font-poppins">
              ...
              they exist. Licensed under CC0 1.0 ©TheBuddiesOfficial
            </p>
            <a
              href="https://github.com/TheBuddiesOfficial/ImageGenX"
