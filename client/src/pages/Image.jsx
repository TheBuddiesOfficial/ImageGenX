  ...
  return (
    <>
      <Helmet>
        ...
        <title>{image.name ? `${image.name}'s AI Image` : "Showcase"} - ImageGenX</title>
        ...
        {/* Og */}
        <meta property="og:title" content={` AI Image - ImageGenX`} />
        <meta
        ...
        <meta
          property="og:url"
          content={`https://imagegenx.vercel.app/showcase/${id}`}
          key="ogurl"
        />
            ...
            <div className="flex justify-between sm:w-[80%] w-full py-7">
              {sharing ? (
                ...
                <button
                  onClick={() =>
                    shareImage(
                      `${image.name} created this image using ImageGenX`,
                      `https://imagegenx.vercel.app/showcase/${id}`
                    )
                  }
